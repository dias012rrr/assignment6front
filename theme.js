function toggleDarkMode() {
    ...
    if (isDarkMode) {
        ...
        document.querySelector("main").style.boxShadow = "0 6px 30px rgba(0, 0, 0, 0.5)";
        ...
        document.querySelector("form").style.boxShadow = "0 4px 10px rgba(0, 0, 0, 0.3)";
        ...
        document.querySelector("button").style.background = "linear-gradient(135deg, #444444, #555555)";
        ...
        document.querySelector("main").style.background = "rgba(255, 255, 255, 0.9)";
        document.querySelector("main").style.boxShadow = "0 6px 30px rgba(0, 0, 0, 0.1)";
...
document.getElementById("themeToggleButton").addEventListener("click", toggleDarkMode);
